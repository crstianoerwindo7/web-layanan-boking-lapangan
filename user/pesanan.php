            ...
            success: function(response) {
                ...
                <div class="modal fade" id="bayarModal${item['212279_id_sewa']}" tabindex="-1" aria-labelledby="bayarModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Bayar  ${item['212279_nama']}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_sewa" value="${item['212279_id_sewa']}">
                        <div class="modal-body">
                          <div class="row justify-content-center align-items-center">
                              ...
                              <div class="mt-3">
                                <label for="exampleInputPassword1" class="form-label">Transfer ke : BRI 123456789012345 a/n Sport Hall </label>
                                <label for="exampleInputPassword1" class="form-label">Transfer ke : BNI 0987654321 a/n Sport Hall </label>
                                <label for="exampleInputPassword1" class="form-label">Transfer ke : BCA 1234567890 a/n Sport Hall </label>
                              </div>
                              <div class="mt-3">
                                <label for="exampleInputPassword1" class="form-label">Upload Bukti</label>
                                <input type="file" name="foto" class="form-control" id="exampleInputPassword1">
              ...
              <div class="modal fade" id="detailModal${item['212279_id_sewa']}" tabindex="-1" role="dialog" aria-labelledby="bayarModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Detail Pembayaran ${item['212279_nama']}</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="" method="post">
                      <div class="modal-body">
