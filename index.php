...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="user/members.php">Our Team</a></li>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-8">
                ...
                <a href="../index.php" data-bs-toggle="modal" data-bs-target="#editProfilModal" class="btn btn-inti">Edit Profil</a>
              </div>
            </div>
          </div>
        </form>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="assets/img/Lapangan futsal.jpg" alt="" data-aos="fade-in">

      <div class="container">
        <h2 data-aos="fade-up" data-aos-delay="100">Ayok Berolahraga Dan<br>Kembangkan Hobimu Di <span class="text-">Gor</span> <br> <span class="text-"> Sport Hall Karpan </span></h2>
        <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
          <a href="login.php" class="btn-get-started">Booking Sekarang <i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2 my-auto" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/foto depan hall.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
            <h3>Sport Hall karpan</h3>
            <p class="fst-italic">
              Sport Hall Karpan adalah tempat yang ideal untuk Anda yang ingin meningkatkan kesehatan dan kebugaran. 
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Fasilitas olahraga terbaru dan terlengkap untuk latihan.</span></li>
            ...
            <a href="Tentang-kami.php" class="read-more "><span>Pelajari Lebih Lanjut</span><i class="bi bi-arrow-right"></i></a>
          </div>
