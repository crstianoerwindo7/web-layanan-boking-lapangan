...
<body class="index-page">
 ...
 <main class="main">
  ...
  src="https://www.google.com/maps?q=-3.688899,128.1978378&hl=id&z=18&output=embed"
  frameborder="0"
  allowfullscreen=""
  loading="lazy"
  ...
  <div class="row gy-4">
    ...
    <div class="col-lg-4">
      <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
        ...
        <div>
          <h3>Address</h3>
          <p>Sport Hall Karpan, Ambon city</p>
        </div>
      </div><!-- End Info Item -->
